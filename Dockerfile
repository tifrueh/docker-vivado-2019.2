...
RUN apt update -y && DEBIAN_FRONTEND=noninteractive apt install -y xorg dbus-x11 lxappearance ubuntu-gnome-default-settings gtk2-engines ttf-ubuntu-font-family fonts-ubuntu-font-family-console fonts-droid-fallback git gcc
